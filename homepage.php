                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr>
                                            ...
                                            <td>{$row['number']}</td>
                                            <td>
                                                <a href='Clients.php?id={$row['id']}' class='btn btn-primary btn-sm'>Edit</a>
                                                <form action='Clients.php' method='POST' style='display:inline;' onsubmit='confirmDelete(event)'>
                                                    <input type='hidden' name='action' value='delete'>
                                                    <input type='hidden' name='id' value='{$row['id']}'>
                                                    <button type='submit' class='btn btn-danger btn-sm' onclick='showOtpModal({$row['id']})'>Delete</button>
                                                </form>
                                            </td>
                                        </tr>";
                                    }
